...
import tr.org.liderahenk.biosupdater.dialogs.BiosUpdaterProfileDialog;
...
/**
 * Profile definition handler for bios-updater plugin.
 *
 */
public class BiosUpdaterProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(BiosUpdaterProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("BiosUpdater"), BiosUpdaterConstants.PLUGIN_NAME, 
					BiosUpdaterConstants.PLUGIN_VERSION, new BiosUpdaterProfileDialog()), 
